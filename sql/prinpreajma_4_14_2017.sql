...
--
-- Table structure for table `con_contact`
--
...
CREATE TABLE `con_contact` (
  ...
  `con_read` int(11) NOT NULL,
  `con_received_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `con_contact`
--

INSERT INTO `con_contact` (`con_id`, `con_subject`, `con_email`, `con_message`, `con_read`, `con_received_date`) VALUES
(1, 'sdfsdf', 'fsdsdf', 'fsdsdf', 0, '2017-04-14 00:37:22');
...
(1, 5, 1, 'restaurant', '0', 'adresa mea', 2, 1, ' date de contact', 'descriere', 'uploads/0', 0, '0', '0', 0, 0, '2017-04-13 21:23:25');
...
(1, 1, 'Luni', 'i', 12, 13),
(2, 1, 'Marti', 'i', 12, 13),
(3, 1, 'Miercuri', 'i', 12, 13),
(4, 1, 'Joi', 'i', 12, 13),
(5, 1, 'Vineri', 'i', 12, 13),
(6, 1, 'Sambata', 'a', 14, 15),
(7, 1, 'Duminica', 'a', 14, 15);
...
--
-- Dumping data for table `rat_rating`
--

INSERT INTO `rat_rating` (`rat_id`, `loc_id`, `rat_nr_voturi`, `rat_suma_totala`, `rat_medie_valori`) VALUES
(2, 6, 1, 5, 5),
(3, 5, 1, 3, 3);
...
CREATE TABLE `usr_users` (
  ...
  `usr_nume` varchar(255) NOT NULL,
  `usr_prenume` varchar(255) DEFAULT NULL,
...
INSERT INTO `usr_users` (`usr_id`, `usr_username`, `usr_nume`, `usr_prenume`, `usr_email`, `usr_password`, `usr_rank`, `usr_premium`, `usr_register_date`, `usr_last_login`, `usr_persoana_juridica`) VALUES
...
(5, 'someuser6', 'dasdf', 'asdasf', 'mateikind6@gmail.com', 'oparola123', 1, 0, '2016-12-24 00:53:05', '0000-00-00 00:00:00', 0),
...
--
-- Dumping data for table `usv_user_ratings`
--

INSERT INTO `usv_user_ratings` (`usv_id`, `usr_id`, `loc_id`) VALUES
(3, 5, 6),
(4, 5, 5);
...
--
ALTER TABLE `cat_categorii`
  MODIFY `cat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `con_contact`
--
ALTER TABLE `con_contact`
...
--
ALTER TABLE `loc_locatii`
  MODIFY `loc_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `prg_program`
  MODIFY `prg_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `rat_rating`
--
ALTER TABLE `rat_rating`
  MODIFY `rat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `usv_user_ratings`
  MODIFY `usv_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
