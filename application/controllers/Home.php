...
class Home extends MY_Controller {
	...
	{
                $this->generalCountyList; 
                //print("<pre>"); print_r($this->generalCountyList); print("</pre>");
		...
		$this->load->view($this->generalViewsList['header']); //apeleaza proprietatea din MY_controller unde stabileste ce header incarca.
                ...
                $this->load->view('home');//asta e singurrul care se schmiba in functie de controllerul accesat.
