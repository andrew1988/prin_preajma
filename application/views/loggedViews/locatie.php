    ...
    <div class="wrapper">
        ...
        <form method="post" action="<?php echo base_url('locatie') ?>" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6">
                    <select name="selectCategory" id="selectCatSelect" onchange="selectForm(this.value)">
                    ...
                    <p>Date Contact</p>
                    <textarea class="form-control" placeholder="Descrierea ofertei" name="contact_data"></textarea>
                    <p>Judet:</p>
                   ...
                   <!-- <p>Promoveaza Restaurantul:</p>
                    ...
                    <div id="serviceFields">
                        campuri speciale pentru formular
                    </div>
                    <div align="center">
