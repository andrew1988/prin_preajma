        ...
        <div class="col-md-10">
            <div class="row" style="width:100%;">
                 ...
                 <?php   
                    ...
                    . '<tr><td>Este admin:</td><td><input type="checkbox" name="usr_rank" '.($user_details[0]['usr_rank'] == 1 ? 'checked':'').' value="1"/></td></tr>'
                    . '<tr><td>Este Juridica:</td><td><input type="checkbox" name="usr_persoana_juridica" '.($user_details[0]['usr_persoana_juridica'] == 1 ? 'checked':'').' value="1"/></td></tr>'
