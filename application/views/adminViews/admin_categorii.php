              ...
              <fieldset>
                ...
                <?php 
                    foreach($categorii as $categorie){
                        ...
                        . '<tr><td>Nume categorie:'.$categorie['cat_nume'].'| Tip Categorie:'.($categorie['cat_type']==0 ? 'Locatie' : 'Servicii') .'</td><td><a href="'.base_url("admin_edit_user").'/'.$categorie['cat_id'].'">Edit</a> |</td>'
                        . '<td><form action="'.base_url("admin_users").'" method="post">'
                        . '<input type="hidden" name="usr_id" value="'.$categorie['cat_id'].'">'
